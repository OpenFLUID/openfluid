...
{
  openfluid::core::EventCollection EvColl, EvColl2;
...
BOOST_AUTO_TEST_CASE(check_operations)
{
  ...
  Ev = new openfluid::core::DistributedEvent(openfluid::core::DateTime(1999,1,1,6,0,0));
  Ev->addInfo("test1","1");
  Ev->addInfo("test2","2");
  EvColl.addEvent(Ev);

  Ev = new openfluid::core::DistributedEvent(openfluid::core::DateTime(2003,2,5,6,0,0));
  Ev->addInfo("test11","11");
  Ev->addInfo("test22","22");
  EvColl.addEvent(Ev);

  Ev = new openfluid::core::DistributedEvent(openfluid::core::DateTime(2023,2,5,6,0,0));
  Ev->addInfo("test111","111");
  Ev->addInfo("test222","222");
  Ev->addInfo("test333","333");
  EvColl.addEvent(Ev);

  Ev = new openfluid::core::DistributedEvent(openfluid::core::DateTime(2010,7,31,16,30,0));
  ...
  BOOST_REQUIRE_EQUAL(EvColl2.getEventsList()->front()->isInfoEquals("specialthing","wedding"),true);
  BOOST_REQUIRE_EQUAL(EvColl2.getEventsList()->front()->isInfoExists("test333"),false);

...
\begin{abstract}
\input{./english/InfiltrationMSeytoux_abstract.tex}
\end{abstract}

%******************************
% Scientific concepts
\section{Scientific concepts}
\input{./english/InfiltrationMSeytoux_scientific_concept.tex}


%******************************
% Functional description
\section{Functional description}
\input{./english/InfiltrationMSeytoux_functional_description.tex}

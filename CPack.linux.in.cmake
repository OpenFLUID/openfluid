...
IF (OFBUILD_ENABLE_DOCALYZER AND OFPACK_FULL_DEPENDENCIES)
  ...
  ENDIF()
  SET(OFPACK_DEPEND_RPM_FEDORA "${OFPACK_DEPEND_RPM_FEDORA}, texlive-scheme-full, \
texlive-collection-fontsextra") # FIXME texlive-scheme-full too heavy, find underlying necessary packages (pdflatex...)
  ...
  ENDIF()
  SET(OFPACK_DEPEND_RPM_CENTOS "${OFPACK_DEPEND_RPM_CENTOS}, texlive-latex")
  IF (OFBUILD_ENABLE_GPL_COMPONENTS)
...
IF(OFBUILD_DISTRO_IS_DEBIAN)
  ...
  IF(OFBUILD_ENABLE_DOCALYZER AND OFBUILD_ENABLE_GPL_COMPONENTS AND OFPACK_FULL_DEPENDENCIES AND (OFBUILD_DISTRO_VERSION LESS "12"))
...
IF(OFBUILD_DISTRO_IS_UBUNTU)
  ...
  IF(OFBUILD_ENABLE_DOCALYZER AND OFBUILD_ENABLE_GPL_COMPONENTS AND OFPACK_FULL_DEPENDENCIES AND (OFBUILD_DISTRO_VERSION LESS "22.10"))
    SET(OFPACK_DEPEND_DEB "${OFPACK_DEPEND_DEB}, pandoc-citeproc")
  ENDIF()
  SET(CPACK_DEBIAN_PACKAGE_DEPENDS "${OFPACK_DEPEND_DEB}")
  SET(CPACK_DEBIAN_PACKAGE_ARCHITECTURE "${OFBUILD_DISTRO_ARCH}")

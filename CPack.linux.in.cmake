...
IF(OFBUILD_DISTRO_IS_DEBIAN)  
  ...
  SET(CPACK_DEBIAN_PACKAGE_DEPENDS "libboost${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}-dev, libboost-test${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}-dev, libqt4-dev (>= 4.8.0), libgdal1-dev, gcc, g++, cmake (>= 2.8.9), gnuplot (>= 4.2), p7zip-full, graphviz, git")    
...
IF(OFBUILD_DISTRO_IS_CENTOS)
  ...
  SET(CPACK_RPM_PACKAGE_REQUIRES "gcc-c++, boost-devel >= 1.40, gdal-devel, qt47-devel, git")
  IF(OFBUILD_ENABLE_LANDR)
...
IF(OFBUILD_DISTRO_IS_FEDORA)
  SET(CPACK_GENERATOR "RPM") 
  SET(CPACK_RPM_PACKAGE_REQUIRES "make, gcc-c++, gcc-gfortran, cmake, boost-devel >= 1.54, gdal-devel, qt-devel, p7zip, gnuplot, graphviz, doxygen, git")
  IF(OFBUILD_ENABLE_LANDR)

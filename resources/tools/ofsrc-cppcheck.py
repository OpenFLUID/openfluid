...
# Compute of the base path of OpenFLUID sources
RootPath = os.path.realpath(os.path.dirname(os.path.realpath(__file__))+'/../..')
...
# Run the configured cppcheck command
Process = subprocess.Popen(FullCommand)
Process.wait()

...
public class NewFunctionWizard extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		...
		final boolean funcEventsOnSUs = dataPage.getFuncEventsOnSUs();
		final boolean funcEventsOnRSs = dataPage.getFuncEventsOnRSs();
		final boolean funcEventsOnGUs = dataPage.getFuncEventsOnGUs();		
			...
			public void run(IProgressMonitor monitor) throws InvocationTargetException {
				try {
					doFinish(containerName, fileName, funcClass, funcMakefile, funcBinName, funcInstallDir,
							 ...
							 funcEventsOnSUs, funcEventsOnRSs, funcEventsOnGUs,
	...
	private void doFinish(String containerName, String fileName, String funcClass, boolean isMakefile, String funcBinName, String funcInstallDir,
						  ...
						  boolean funcEventsOnSUs, boolean funcEventsOnRSs, boolean funcEventsOnGUs,
	...
	private InputStream openCPPContentStream(String fileName, String funcClass, 
		...
		// events
		if (funcEventsOnSUs) events = events + "  DECLARE_USED_SU_EVENTS;\n";
		if (funcEventsOnRSs) events = events + "  DECLARE_USED_RS_EVENTS;\n";
		if (funcEventsOnGUs) events = events + "  DECLARE_USED_GU_EVENTS;\n";		
		...
		String contents =
			...
			"\n" +
			"\n" +
            "DEFINE_FUNCTION_HOOK(" + funcClass + ");\n" +
			"\n" +
			"\n" +			
			"// =====================================================================\n" +
			"// =====================================================================\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::initParams(openfluid::core::ParamsMap Params)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::initializeRun(const openfluid::base::SimulationInfo* SimInfo)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::runStep(const openfluid::base::SimulationStatus* SimStatus)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::finalizeRun(const openfluid::base::SimulationInfo* SimInfo)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
	...
	private InputStream openHContentStream(String fileName, String funcClass) {
		...
		String contents =
			...
			"\n" +
			"*/\n" +		
			"class "+funcClass+ " : public openfluid::base::PluggableFunction\n" +
			"{\n" + 
			"  private:\n" +
			"\n" +
			"  public:\n" +

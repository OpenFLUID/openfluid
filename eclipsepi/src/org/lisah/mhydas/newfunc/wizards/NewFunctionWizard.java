...
public class NewFunctionWizard extends Wizard implements INewWizard {
	...
	private InputStream openCPPContentStream(String fileName, String funcClass, 
		...
		String contents =
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::initializeRun(const mhydasdk::base::SimulationInfo* SimInfo)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::runStep(const mhydasdk::base::SimulationStatus* SimStatus)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +
			...
			"\n" +
			"\n" +
			"bool " + funcClass + "::finalizeRun(const mhydasdk::base::SimulationInfo* SimInfo)\n" +
			"{\n" +
			"\n" +
			"\n" +
			"  return true;\n" +

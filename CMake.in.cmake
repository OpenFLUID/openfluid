...
SET(OPENFLUID_FUNCPLUGSDIR "functions")
...
SET(OBSERVERS_INSTALL_PATH "lib/openfluid/observers")
SET(BUILDEREXT_INSTALL_PATH "lib/openfluid/builderext")

SET(PKGCONFIG_INSTALL_PATH "lib/pkgconfig")

IF (WIN32)
  SET(CMAKE_MODULES_INSTALL_PATH "lib/cmake")
ELSE()
  SET(CMAKE_MODULES_INSTALL_PATH "lib/openfluid/cmake")
ENDIF()  
...
SET(OPENFLUID_FUNCTIONS_SUFFIX "_ofware-func")

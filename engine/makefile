...
ubuntu-packages: ubuntu-prepack ubuntu-packages-functions-mhydas ubuntu-packages-functions-standard
	...
	@echo "Version: $(MAJORVER).$(MINORVER)$(RELEASESTATUS)" >> $(BASEPACKDIR)/$(LOCALDIR)/$(ENGPACKNAME)/DEBIAN/control
...
ubuntu-packages-functions-mhydas:
	...
	@echo "Version: $(MAJORVER).$(MINORVER)$(RELEASESTATUS)" >> $(BASEPACKDIR)/$(LOCALDIR)/$(MHYDASFUNCSPACKNAME)/DEBIAN/control
	...
	@echo "Depends: $(ENGPACKROOT) (= $(MAJORVER).$(MINORVER)$(RELEASESTATUS))" >> $(BASEPACKDIR)/$(LOCALDIR)/$(MHYDASFUNCSPACKNAME)/DEBIAN/control
...
ubuntu-packages-functions-standard:
	...
	@echo "Version: $(MAJORVER).$(MINORVER)$(RELEASESTATUS)" >> $(BASEPACKDIR)/$(LOCALDIR)/$(STDFUNCSPACKNAME)/DEBIAN/control
	...
	@echo "Depends: $(ENGPACKROOT) (= $(MAJORVER).$(MINORVER)$(RELEASESTATUS))" >> $(BASEPACKDIR)/$(LOCALDIR)/$(STDFUNCSPACKNAME)/DEBIAN/control

...
LIST(GET OFBUILD_ARCH_RUN_OUTPUT 0 OFBUILD_PROC_CLASS)
LIST(GET OFBUILD_ARCH_RUN_OUTPUT 1 OFBUILD_SYSTEM_CLASS)

SET(OFBUILD_ARCH_CLASS ${OFBUILD_PROC_CLASS}-${OFBUILD_SYSTEM_CLASS})
  ...
  IF(NOT APPLE) 
    ...
    ELSE()
      ...
      IF(OFBUILD_DISTRO_ID STREQUAL "Debian")
        ...
        IF(${OFBUILD_PROC_CLASS} STREQUAL "x86-64")
          SET(OFBUILD_DISTRO_ARCH "amd64")
        ELSEIF(${OFBUILD_PROC_CLASS} STREQUAL "arm64")
          SET(OFBUILD_DISTRO_ARCH "arm64")
        ELSE()
          SET(${OFBUILD_PROC_CLASS} "i386")
        ENDIF()
      ENDIF()    
      ...
      IF(OFBUILD_DISTRO_ID STREQUAL "CentOS")
        ...
        ELSEIF(${OFBUILD_PROC_CLASS} STREQUAL "arm64")
          SET(OFBUILD_DISTRO_ARCH "aarch64")
        ELSE()
          SET(${OFBUILD_PROC_CLASS} "i686")
        ENDIF()

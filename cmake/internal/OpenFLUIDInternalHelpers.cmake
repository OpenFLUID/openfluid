...
MACRO(OFBUILD_ADD_UNITTEST TEST_CAT TEST_NAME CPP_FILE HEAVY_TEST)
  ADD_EXECUTABLE("${TEST_CAT}-${TEST_NAME}" ${CPP_FILE})
  ...
  SET(UNIT_TEST_NAME "unit-${TEST_CAT}-${TEST_NAME}")                      
  ADD_TEST(${UNIT_TEST_NAME} "${OFBUILD_TESTS_BINARY_DIR}/${TEST_CAT}-${TEST_NAME}" ${OFBUILD_UNITTESTS_RUN_OPTIONS})

  IF(HEAVY_TEST)
    SET_PROPERTY(TEST ${UNIT_TEST_NAME} APPEND PROPERTY LABELS HEAVYTEST)
  ENDIF()
...
MACRO(OFBUILD_DISCOVER_UNITTESTS TEST_CAT)
  ...
  FOREACH(CPPFILE ${UNIT_TESTS_CPP})
    ...
    OFBUILD_ADD_UNITTEST(${TEST_CAT} ${CPPFILE_WE} ${CPPFILE} OFF)
  ENDFOREACH()
ENDMACRO()
...
MACRO(OFBUILD_DISCOVER_HEAVYUNITTESTS TEST_CAT)
  IF(OFBUILD_TESTS_ENABLE_HEAVY)
    ...
    FOREACH(CPPFILE ${UNIT_TESTS_CPP})
      GET_FILENAME_COMPONENT(CPPFILE_WE ${CPPFILE} NAME_WE)
      OFBUILD_ADD_UNITTEST(${TEST_CAT} ${CPPFILE_WE} ${CPPFILE} ON)
    ENDFOREACH()
  ENDIF()
ENDMACRO()

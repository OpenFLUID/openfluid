...
MACRO(OPNFLD_ADD_BUILDER_EXTENSION_WITH_INSTALL EXT_NAME EXT_SRCDIR EXT_BINDIR)
  ...
  INSTALL(TARGETS "${EXT_NAME}${OPENFLUID_BUILDEREXTS_SUFFIX}"
          DESTINATION "${BUILDEREXT_INSTALL_PATH}")
...
MACRO(OPNFLD_ADD_UNITTEST TEST_CAT TEST_NAME)
  ...
  IF(TESTS_USERDATA_PATH)
    SET_TESTS_PROPERTIES("unit-${TEST_CAT}-${TEST_NAME}" PROPERTIES ENVIRONMENT "OPENFLUID_USERDATA_PATH=${TESTS_USERDATA_PATH}")  
  ENDIF()
ENDMACRO()

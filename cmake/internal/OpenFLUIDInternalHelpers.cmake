...
FUNCTION(OFBUILD_ADD_EXAMPLE_SIMULATOR SIMID ROOTCPPFILENAME DOCBUILD)
  ...
  FILE(WRITE ${CURR_WARE_DIR}/AROFILE "${CMAKEIN_ARO}")
  
  CONFIGURE_FILE(${CURR_WARE_DIR}/AROFILE ${CURR_WARE_DIR}/CMake.in.config)
  
  #CMAKELISTS.TXT
  FILE(COPY ${TEMPLATE_DIR}/CMakeLists.txt.tpl DESTINATION ${CURR_WARE_DIR}/)
  FILE(RENAME ${CURR_WARE_DIR}/CMakeLists.txt.tpl ${CURR_WARE_DIR}/CMakeLists.txt)

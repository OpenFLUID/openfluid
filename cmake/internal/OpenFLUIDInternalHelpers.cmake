...
FUNCTION(OFBUILD_ADD_SIMULATOR SIM_SRCDIR SIM_BINDIR)
  ...
  TARGET_COMPILE_DEFINITIONS("${SIM_ID}${OPENFLUID_SIMULATORS_SUFFIX}" PRIVATE 
                             ...
                             WAREBUILD_COMPILER_FLAGS="${OFBUILD_ALL_COMPILE_FLAGS_STR}")
...
FUNCTION(OFBUILD_ADD_EXAMPLE_SIMULATOR SIMID ROOTCPPFILENAME DOCBUILD)
  ...
  SET(WAREID ${SIMID})
  SET(ROOTCPPFILENAME ${ROOTCPPFILENAME})
  SET(TEMPLATE_DIR ${CMAKE_SOURCE_DIR}/${OPENFLUID_SHARE_WARESDEV_INSTALL_PATH}/templates/simulators/)
  ...
  # CMAKE.IN.CONFIG
  FILE(READ "${TEMPLATE_DIR}/CMake.in.config.tpl" CMAKEIN_TPL)
  STRING(REPLACE "%%" "@" CMAKEIN_ARO "${CMAKEIN_TPL}")
  FILE(WRITE ${CURR_WARE_DIR}/CMAKEIN_AROFILE "${CMAKEIN_ARO}")
    CONFIGURE_FILE(${CURR_WARE_DIR}/CMAKEIN_AROFILE "${CURR_WARE_DIR}/CMake.in.config")
  FILE(REMOVE ${CURR_WARE_DIR}/CMAKEIN_AROFILE)
  FILE(REMOVE "${CURR_WARE_DIR}/CMake.in.cmake")

  #CMAKELISTS.TXT
  FILE(READ "${TEMPLATE_DIR}/CMakeLists.txt.tpl" CMAKELISTS_TPL)
  STRING(REPLACE "%%" "@" CMAKELISTS_ARO "${CMAKELISTS_TPL}")
  FILE(WRITE ${CURR_WARE_DIR}/CMAKELISTS_AROFILE "${CMAKELISTS_ARO}")
  CONFIGURE_FILE(${CURR_WARE_DIR}/CMAKELISTS_AROFILE "${CURR_WARE_DIR}/CMakeLists.txt")
  FILE(REMOVE ${CURR_WARE_DIR}/CMAKELISTS_AROFILE)

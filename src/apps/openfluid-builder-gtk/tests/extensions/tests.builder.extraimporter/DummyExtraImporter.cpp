...
#include <openfluid/builderext-gtk/ExtraImporter.hpp>

#include <gtkmm/messagedialog.h>

DECLARE_EXTENSION_HOOKS;

DEFINE_EXTENSION_INFOS("tests.builder.extraimporter",
                       "Dummy extra importer",
...
class DummyExtraImporter : public openfluid::builderext::ExtraImporter
{
  private:

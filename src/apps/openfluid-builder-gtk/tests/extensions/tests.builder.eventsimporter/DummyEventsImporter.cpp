...
#include <openfluid/builderext-gtk/EventsImporter.hpp>

#include <gtkmm/messagedialog.h>

DECLARE_EXTENSION_HOOKS;

DEFINE_EXTENSION_INFOS("tests.builder.eventsimporter",
                       "Dummy events importer",
...
class DummyEventsImporter : public openfluid::builderext::EventsImporter
{
  private:

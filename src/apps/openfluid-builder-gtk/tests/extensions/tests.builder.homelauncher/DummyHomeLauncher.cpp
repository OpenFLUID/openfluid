...
#include <openfluid/builderext-gtk/HomeLauncher.hpp>

#include <gtkmm/messagedialog.h>

DECLARE_EXTENSION_HOOKS;

DEFINE_EXTENSION_INFOS("tests.builder.homelauncher",
                       "Dummy home launcher",
...
class DummyHomeLauncher : public openfluid::builderext::HomeLauncher
{
  private:
  ...
  public:
    ...
    DummyHomeLauncher()
    {
      mp_Dialog = new Gtk::MessageDialog("I am DummyHomeLauncher");
    };

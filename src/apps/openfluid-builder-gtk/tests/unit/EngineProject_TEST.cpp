...
/**
 \file EngineProject_TEST.cpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __ENGINEPROJECT_TEST_CPP__
#define __ENGINEPROJECT_TEST_CPP__

#define BOOST_TEST_MAIN
#define BOOST_AUTO_TEST_MAIN
#define BOOST_TEST_DYN_LINK
#define BOOST_TEST_MODULE builder_unittest_EngineProject
...
#endif /* __ENGINEPROJECT_TEST_CPP__ */

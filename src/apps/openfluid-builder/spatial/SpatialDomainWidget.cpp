...
void SpatialDomainWidget::refresh()
{
  ...
  QStringList OriginalClassesList = openfluid::ui::toQStringList(m_Domain.getClassNames());
  ...
  if (TmpList.empty())
  {
    ...
    ->setProjectContextValue("/builder/spatial/unitsclasses","order",
                             openfluid::ui::toStdStringVector(OriginalClassesList));
    ClassesList = OriginalClassesList;
  }
  else
  {
    ClassesList = openfluid::ui::toQStringList(TmpList);
    ...
    openfluid::base::RunContextManager::instance()
      ->setProjectContextValue("/builder/spatial/unitsclasses","order",
                               openfluid::ui::toStdStringVector(ClassesList));
  }
...
void SpatialDomainWidget::refreshClassAttributes()
{
  ...
  if (!m_ActiveClass.isEmpty())
  {
    QStringList AttrNames = openfluid::ui::toQStringList(m_Domain.getAttributesNames(m_ActiveClass.toStdString()));
    QStringList IDs = openfluid::ui::toQStringList(m_Domain.getIDsOfClass(m_ActiveClass.toStdString()));
...
{
  QStringList ExistingClasses = openfluid::ui::toQStringList(m_Domain.getClassNames());
...
{
  QStringList AttrsNames = openfluid::ui::toQStringList(m_Domain.getAttributesNames(m_ActiveClass.toStdString()));

  QStringList UnitsIDs = openfluid::ui::toQStringList(m_Domain.getIDsOfClass(m_ActiveClass.toStdString()));
...
{
  QStringList UnitsIDsList = openfluid::ui::toQStringList(m_Domain.getIDsOfClass(m_ActiveClass.toStdString()));

  ...
  QWidget(Parent),ui(new Ui::NewslineWidget)
{
  ...
  ui->NewslineLabel->setStyleSheet(QString("color : %1; background-color : %2;").arg(BUILDER_NEWSLINE_TEXTCOLOR,
                                                                                     BUILDER_NEWSLINE_BGCOLOR));

  ui->NoNewsLabel->setStyleSheet(QString("color : %1; background-color : %2;").arg(BUILDER_NEWSLINE_TEXTCOLOR,
                                                                                   BUILDER_NEWSLINE_BGCOLOR));
...
void NewslineWidget::refreshFromCache()
{
  ...
  QString RSSFile =
      ...
      .arg(NewsItemWidget::getLocale().name().left(2));

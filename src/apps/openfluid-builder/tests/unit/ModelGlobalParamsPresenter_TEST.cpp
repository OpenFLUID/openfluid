...
BOOST_AUTO_TEST_CASE(test_globalparams_management)
{
  ...
  BOOST_CHECK_EQUAL(mp_EngProject->getModelInstance()->getGlobalParameters()["strparam"].toString(),"");
  ...
  BOOST_CHECK_EQUAL(mp_EngProject->getModelInstance()->getGlobalParameters()["strparam"].toString(),"abc");

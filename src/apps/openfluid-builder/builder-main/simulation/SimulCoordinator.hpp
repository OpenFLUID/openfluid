...
/**
 \file SimulCoordinator.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __SIMULCOORDINATOR_HPP__
#define __SIMULCOORDINATOR_HPP__
...
class SimulCoordinator: public sigc::trackable
{
  private:
    SimulRunModel& m_RunModel;
    ...
    void updateOutSetsListToolBox();
    void whenFromUserFileFormatSelectionChanged();
    void whenFromUserSetSelectionChanged();
    void whenAddFileFormatAsked();
    void whenAddSetAsked();
    void whenRemoveFileFormatAsked();
    void whenRemoveSetAsked();
    void whenEditFileFormatAsked();
    void whenEditSetAsked();
  public:
    SimulCoordinator(SimulRunModel& RunModel,
        SimulOutFilesModel& OutFilesModel,
...
#endif /* __SIMULCOORDINATOR_HPP__ */

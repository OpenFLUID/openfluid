...
/**
 \file BuilderSimulationModule.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __BUILDERSIMULATIONMODULE_HPP__
#define __BUILDERSIMULATIONMODULE_HPP__
...
class SimulCoordinator;
class BuilderListToolBoxFactory;
class BuilderListToolBox;


class BuilderSimulationModule: public BuilderModule
{
  private:
    Gtk::Box* mp_MainPanel;
  protected:
    SimulRunComponent* mp_SimulRunMVP;
    ...
    SimulCoordinator* mp_Coordinator;
  public:
    BuilderSimulationModule(BuilderListToolBoxFactory& ListToolBoxFactory);
    ~BuilderSimulationModule();
    void initialize();
...
class BuilderSimulationModuleSub: public BuilderSimulationModule
{
  public:
    BuilderSimulationModuleSub(BuilderListToolBoxFactory& ListToolBoxFactory);
};

#endif /* __BUILDERSIMULATIONMODULE_HPP__ */

...
/**
 \file DrawingAreaInitialState.cpp
 \brief Implements ...
...
void DrawingAreaInitialState::onMouseButtonPressed(GdkEventButton* /*event*/)
{
...
bool DrawingAreaInitialState::onMouseButtonReleased(GdkEventButton* /*event*/)
{
  return true;
}

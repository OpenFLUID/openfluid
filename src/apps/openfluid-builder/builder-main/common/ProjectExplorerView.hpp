...
class ProjectExplorerView
{
  public:
    ...
    virtual Gtk::TreePath getActivatedPath() = 0;
...
class ProjectExplorerViewImpl: public ProjectExplorerView
{
  private:

...
/**
 \file ProjectExplorerComponent.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __PROJECTEXPLORERCOMPONENT_HPP__
#define __PROJECTEXPLORERCOMPONENT_HPP__
...
class ProjectExplorerComponent: public BuilderMVPComponent
{
  protected:
    ...
    ProjectExplorerView* mp_View;

    ProjectExplorerPresenter* mp_Presenter;

    ProjectExplorerAdapter* mp_Adapter;

    ProjectExplorerAdapterModel* mp_AdapterModel;

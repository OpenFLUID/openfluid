...
/**
 \file ProjectExplorerAdapter.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __PROJECTEXPLORERADAPTER_HPP__
#define __PROJECTEXPLORERADAPTER_HPP__
...
class ProjectExplorerAdapter: public sigc::trackable
{
  private:

    ProjectExplorerAdapterModel& m_Model;

    ProjectExplorerView& m_View;

    sigc::signal<void> m_signal_FromUserActivationChanged;

    void whenActivationChanged();

  public:

    ProjectExplorerAdapter(ProjectExplorerAdapterModel& Model,

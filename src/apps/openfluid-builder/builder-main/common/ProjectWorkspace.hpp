...
class ProjectWorkspace
{
  protected:
    ...
    std::map<std::string,Gtk::Widget*> m_ByNamePagesMap;
  ...
  public:
    ...
    sigc::signal<void, std::string> signal_PageRemoved();

    bool existsPageName(std::string PageName);

    void setCurrentPage(std::string PageName);

    void appendPage(std::string PageName, Gtk::Widget* PageContent);

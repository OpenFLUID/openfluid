...
void ModelCoordinator::whenAvailFctSelectionChanged()
{
  if (m_AvailFctModel.isASignatureSelected())
  {
    setFctToDisplay(m_AvailFctModel.getSelectedSignature());
    m_StructureListToolBox.setAddCommandAvailable(true);
  } else
    m_StructureListToolBox.setAddCommandAvailable(false);
}
void ModelCoordinator::whenStructureFctSelectionChanged()
{
  updateStructureListToolBox();
}
void ModelCoordinator::whenAddFctAsked()
{
  m_StructureModel.appendFunction(*m_AvailFctModel.getSelectedSignature());
  updateStructureListToolBox();
}
void ModelCoordinator::whenRemoveFctAsked()
{
  m_StructureModel.removeFunctionAt(m_StructureModel.getCurrentSelection());
  updateStructureListToolBox();
}
void ModelCoordinator::whenMoveTowardTheBeginAsked()
{
  m_StructureModel.moveTowardTheBegin();
}
void ModelCoordinator::whenMoveTowardTheEndAsked()
{
...
{
  m_FctDetailModel.setFctToDisplay(Signature);
}
void ModelCoordinator::setEngineRequirements(

...
/**
 \file ModelAvailFctComponent.cpp
 \brief Implements ...
...
ModelAvailFctComponent::ModelAvailFctComponent()
{
  ...
  mp_Model = new ModelAvailFctModelImpl();
  mp_View = new ModelAvailFctViewImpl(*TreeColumns);
  mp_AdapterModel = new ModelAvailFctAdapterModelImpl(*TreeColumns);

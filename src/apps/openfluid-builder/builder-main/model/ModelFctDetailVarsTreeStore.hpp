...
class ModelFctDetailVarsTreeStore: public ModelFctDetailTreeStore
{
  private:
  ...
  public:
        ...
        ModelFctDetailColumns& Columns)
    {
      return Glib::RefPtr<ModelFctDetailTreeStore>(
          new ModelFctDetailVarsTreeStore(Columns));
    }
    ~ModelFctDetailVarsTreeStore()
    {
...
#endif /* __MODELFCTDETAILVARSTREESTORE_HPP__ */

...
/**
 \file ModelFctDetailAdapter.cpp
 \brief Implements ...
    ...
    openfluid::machine::SignatureItemInstance* Signature)
{
  ...
  m_View.setParamsModel(m_Model.getParamsModel());
  m_View.setVarsModel(m_Model.getVarsModel());
  m_View.setIDataModel(m_Model.getIDataModel());
  m_View.setEventsModel(m_Model.getEventsModel());
  m_View.setExtraFilesModel(m_Model.getExtraFilesModel());
  m_View.setPluggableElementsVisible(m_Model.isAPluggableFct());
}

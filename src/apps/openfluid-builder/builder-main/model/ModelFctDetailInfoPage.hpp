...
/**
 \file ModelFctDetailInfoPage.hpp
 \brief Header of ...
...
class ModelFctDetailInfoPage
{
  private:
    ...
    ModelFctDetailInfoTableRow* mp_DescriptionRow;
    ModelFctDetailInfoTableRow* mp_VersionRow;
    ModelFctDetailInfoTableRow* mp_StatusRow;
    ModelFctDetailInfoTableRow* mp_DomainRow;
    ModelFctDetailInfoTableRow* mp_ProcessRow;
    ModelFctDetailInfoTableRow* mp_MethodRow;
    ModelFctDetailInfoTableRow* mp_AuthorRow;
    ModelFctDetailInfoTableRow* mp_AuthorMailRow;

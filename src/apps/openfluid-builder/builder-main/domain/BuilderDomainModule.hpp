...
/**
 \file BuilderDomainModule.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __BUILDERDOMAINMODULE_HPP__
#define __BUILDERDOMAINMODULE_HPP__
...
class BuilderDomainModule: public BuilderModule
{
  private:
  ...
  protected:
    ...
    DomainCoordinator* mp_Coordinator;
  public:
    BuilderDomainModule(BuilderListToolBoxFactory& ListToolBoxFactory);
    ~BuilderDomainModule();
    void initialize();
...
class BuilderDomainModuleSub: public BuilderDomainModule
{
  public:
    BuilderDomainModuleSub(BuilderListToolBoxFactory& ListToolBoxFactory);
};

#endif /* __BUILDERDOMAINMODULE_HPP__ */

...
/**
 \file DomainCoordinator.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __DOMAINCOORDINATOR_HPP__
#define __DOMAINCOORDINATOR_HPP__
...
class DomainCoordinator: public sigc::trackable
{
  private:
    ...
    void whenAddUnitAsked();
    void whenRemoveUnitAsked();
    void whenEditUnitAsked();
    void whenStructureSelectionChanged();
    void whenAddIDataAsked();
    void whenRemoveIDataAsked();
  public:
    DomainCoordinator(DomainStructureModel& StructureModel,
...
#endif /* __DOMAINCOORDINATOR_HPP__ */

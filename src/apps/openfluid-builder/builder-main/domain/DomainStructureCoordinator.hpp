...
/**
 \file DomainStructureCoordinator.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __DOMAINSTRUCTURECOORDINATOR_HPP__
#define __DOMAINSTRUCTURECOORDINATOR_HPP__
...
class DomainStructureCoordinator: public sigc::trackable
{
  private:
    ...
    sigc::signal<void> m_signal_DomainChanged;
...
#endif /* __DOMAINSTRUCTURECOORDINATOR_HPP__ */

...
/**
 \file DomainIAttributesAddDialog.cpp
 \brief Implements ...
...
DomainAttributesAddDialog::DomainAttributesAddDialog(
...
{
  mp_Dialog = new Gtk::Dialog(_("Adding attribute field"));
  ...
  mp_NameEntry->signal_changed().connect(
      sigc::mem_fun(*this, &DomainAttributesAddDialog::onChanged));
...
void DomainAttributesAddDialog::onChanged()
{
  ...
  else if (m_AttrsNames.count(Name))
  {
...
bool DomainAttributesAddDialog::show()
{

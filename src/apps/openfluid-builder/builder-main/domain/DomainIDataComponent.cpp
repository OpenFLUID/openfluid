...
Gtk::Widget* DomainIDataComponent::asWidget()
{
  return mp_View->asWidget();
}
DomainIDataModel* DomainIDataComponent::getModel()
{
  return mp_Model;
}
DomainIDataView* DomainIDataComponent::getView()
{
  return mp_View;
}

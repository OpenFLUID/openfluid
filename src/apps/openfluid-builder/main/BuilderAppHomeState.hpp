...
/**
 \file BuilderAppHomeState.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __BUILDERAPPHOMESTATE_HPP__
#define __BUILDERAPPHOMESTATE_HPP__
...
class BuilderAppHomeState: public BuilderAppState
{
  ...
  public:
    BuilderAppHomeState(BuilderAppCoordinator& AppCoordinator);

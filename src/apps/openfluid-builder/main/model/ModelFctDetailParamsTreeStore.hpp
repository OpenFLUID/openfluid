...
/**
 \file ModelFctDetailParamsTreeStore.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __MODELFCTDETAILPARAMSTREESTORE_HPP__
#define __MODELFCTDETAILPARAMSTREESTORE_HPP__

#include "ModelFctDetailTreeStore.hpp"

class ModelFctDetailParamsTreeStore: public ModelFctDetailTreeStore
{
  private:
    ModelFctDetailParamsTreeStore(ModelFctDetailColumns& Columns) :
...
#endif /* __MODELFCTDETAILPARAMSTREESTORE_HPP__ */

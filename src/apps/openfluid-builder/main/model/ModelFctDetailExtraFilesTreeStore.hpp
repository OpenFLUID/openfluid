...
/**
 \file ModelFctDetailExtraFilesTreeStore.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __MODELFCTDETAILEXTRAFILESTREESTORE_HPP__
#define __MODELFCTDETAILEXTRAFILESTREESTORE_HPP__

#include "ModelFctDetailTreeStore.hpp"

class ModelFctDetailExtraFilesTreeStore: public ModelFctDetailTreeStore
{
  private:
    Gtk::TreeRowReference* m_RequiredTitleRow;
    Gtk::TreeRowReference* m_UsedTitleRow;
    ModelFctDetailExtraFilesTreeStore(ModelFctDetailColumns& Columns) :
  ...
  public:
        ...
        ModelFctDetailColumns& Columns)
    {
      return Glib::RefPtr<ModelFctDetailTreeStore>(
          new ModelFctDetailExtraFilesTreeStore(Columns));
    }
    ~ModelFctDetailExtraFilesTreeStore()
    {
    ...
    void extractInnerItems(std::vector<std::string> Items,
    ...
    void extractItems(openfluid::base::FunctionSignature* Signature)
    {
      extractInnerItems(Signature->HandledData.RequiredExtraFiles,
          m_RequiredTitleRow);
      extractInnerItems(Signature->HandledData.UsedExtraFiles, m_UsedTitleRow);
    }
};

#endif /* __MODELFCTDETAILEXTRAFILESTREESTORE_HPP__ */

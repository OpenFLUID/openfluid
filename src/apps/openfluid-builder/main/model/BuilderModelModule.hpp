...
/**
 \file BuilderModelModule.hpp
 \brief Header of ...

 \author Aline LIBRES <libres@supagro.inra.fr>
 */

#ifndef __BUILDERMODELMODULE_HPP__
#define __BUILDERMODELMODULE_HPP__
...
class BuilderModelModule: public BuilderModule
{
  ...
  public:
    BuilderModelModule(BuilderListToolBoxFactory& ListToolBoxFactory);
    ~BuilderModelModule();
    void initialize();
    void
...
class BuilderModelModuleSub: public BuilderModelModule
{
  public:
    BuilderModelModuleSub(BuilderListToolBoxFactory& ListToolBoxFactory);
    ModelAvailFctModel* getAvailFctMVPModel();
    ModelFctDetailModel* getModelFctDetailMVPModel();
    ModelStructureModel* getModelStructureMVPModel();
    BuilderListToolBox* getModelStructureListToolBox();
    ModelCoordinator* getCoordinator();
};

#endif /* __BUILDERMODELMODULE_HPP__ */

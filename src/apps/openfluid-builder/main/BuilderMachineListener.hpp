...
class BuilderMachineListener: public openfluid::machine::MachineListener
{
  private:
    ...
    void displayStatusWithLeftMargin(
  ...
  public:
    ...
    virtual void onModelBuildDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onLandscapeBuild();
    virtual void onLandscapeBuildDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onRunConfiguration();

    virtual void onRunConfigurationDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onInitParams();

    virtual void onInitParamsDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onPrepareData();

    virtual void onPrepareDataDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onCheckConsistency();

    virtual void onCheckConsistencyDone(
        const openfluid::base::Listener::Status& Status);

    virtual void onInitializeRun();

    virtual void onInitializeRunDone(
        const openfluid::base::Listener::Status& Status);
    ...
    virtual void onFinalizeRunDone(
        const openfluid::base::Listener::Status& Status);

    void linkWithTextView(Gtk::TextView * TextView);

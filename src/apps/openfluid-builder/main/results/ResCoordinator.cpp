...
void ResCoordinator::whenFromUserViewResultAsked()
{
  m_ViewerModel.initialize(m_ChooserModel.getSelectedSetDescriptor(),
      m_ChooserModel.getSelectedUnit());
}

ResCoordinator::ResCoordinator(ResChooserModel& ChooserModel,
  ...
  m_ChooserModel(ChooserModel), m_ViewerModel(ViewerModel)
{
  m_ChooserModel.signal_ViewResultAsked().connect(sigc::mem_fun(*this,
      &ResCoordinator::whenFromUserViewResultAsked));
}
void ResCoordinator::setEngineRequirements(
...
void ResCoordinator::initialize()
{
  m_ChooserModel.initialize();
  m_ViewerModel.clear();
}

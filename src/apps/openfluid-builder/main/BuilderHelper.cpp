...
Gtk::StockID * BuilderHelper::createIconStockId(Glib::ustring FilePath, Glib::ustring FileName, Glib::ustring StockIdString)
{
  ...
  Glib::RefPtr<Gtk::IconFactory> BuilderIconFactory = Gtk::IconFactory::create();

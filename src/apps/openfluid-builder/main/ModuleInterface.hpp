...
#ifndef __MODULEINTERFACE_HPP__
#define __MODULEINTERFACE_HPP__
...
class ModuleInterface
{
  public:
    ...
    Gtk::Container * getContainer() { return mp_Container; };
    ...
    Glib::ustring getModuleLongName() { return m_ModuleLongName; };
  ...
  protected:
    ...
    Glib::ustring m_ModuleLongName;

    Gtk::StockID * mp_StockId;

...
#define THIS_FUNC_ID "tests.primitives.runenv"
...
class RunEnvPrimitivesFunction : public openfluid::ware::PluggableFunction
{
  private:
  ...
  public:
    ...
    RunEnvPrimitivesFunction() : PluggableFunction()
    {

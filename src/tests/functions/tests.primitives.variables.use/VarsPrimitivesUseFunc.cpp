...
#define THIS_FUNC_ID "tests.primitives.variables.use"
    ...
    openfluid::base::SchedulingRequest runStep()
    {
        ...
        OPENFLUID_UNITS_ORDERED_LOOP("TestUnits",TU)
        {
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (!openfluid::tools::IsCloseEnough(VarDouble,PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect double value at t-1 (tests.double)");
          }
          ...
          OPENFLUID_GetVariable(TU,"tests.doubleval",CurrIndex,VarDoubleVal);
          if (VarDoubleVal.get() != RefDouble)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect double value (tests.doubleval) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (!openfluid::tools::IsCloseEnough(VarDoubleVal.get(),PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect double value at t-1 (tests.doubleval)");
          }

          OPENFLUID_GetVariable(TU,"tests.doubleval",CurrIndex,&VarDoubleVal);

          if (!openfluid::tools::IsCloseEnough(VarDoubleVal.get(),NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect double value after update (tests.doubleval)");
          ...
          if (VarLong != RefLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value (tests.integer)");

          VarLong = 0;
          OPENFLUID_GetVariable(TU,"tests.integer",CurrIndex,VarLong);
          if (VarLong != RefLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value (tests.integer) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarLong != PreLong)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value at t-1 (tests.integer)");
          }

          OPENFLUID_GetVariable(TU,"tests.integer",CurrIndex,&VarLong);

          if (VarLong != NewLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value after update (tests.integer)");
          ...
          if (VarLongVal.get() != RefLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value (tests.integerval)");

          VarLongVal.set(0);
          OPENFLUID_GetVariable(TU,"tests.integerval",CurrIndex,VarLongVal);
          if (VarLongVal.get() != RefLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value (tests.integerval) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarLongVal.get() != PreLong)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value at t-1 (tests.integerval)");
          }

          OPENFLUID_GetVariable(TU,"tests.integerval",CurrIndex,&VarLongVal);

          if (VarLongVal.get() != NewLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value after update (tests.integerval)");
          ...
          if (VarBool != RefBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value (tests.bool)");

          VarBool = false;
          OPENFLUID_GetVariable(TU,"tests.bool",CurrIndex,VarBool);
          if (VarBool != RefBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value (tests.bool) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarBool != PreBool)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value at t-1 (tests.bool)");
          }

          OPENFLUID_GetVariable(TU,"tests.bool",CurrIndex,&VarBool);

          if (VarBool != NewBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value after update (tests.bool)");
          ...
          if (VarBoolVal.get() != RefBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value (tests.boolval)");

          VarBoolVal.set(false);
          OPENFLUID_GetVariable(TU,"tests.boolval",CurrIndex,VarBoolVal);
          if (VarBoolVal.get() != RefBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value (tests.boolval) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarBoolVal.get() != PreBool)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value at t-1 (tests.boolval)");
          }

          OPENFLUID_GetVariable(TU,"tests.boolval",CurrIndex,&VarBoolVal);

          if (VarBoolVal.get() != NewBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect bool value after update (tests.boolval)");
          ...
          if (VarString != RefString)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect string value (tests.string)");

          VarString = "";
          OPENFLUID_GetVariable(TU,"tests.string",CurrIndex,VarString);
          if (VarString != RefString)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect string value (tests.string) get by reference");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarString != PreString)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect string value at t-1 (tests.string)");
          }

          OPENFLUID_GetVariable(TU,"tests.string",CurrIndex,&VarString);

          if (VarString != NewString)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect string value after update (tests.string)");
          ...
          if (VarNullVal.getType() != openfluid::core::Value::NULLL)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect null value (tests.null)");

          OPENFLUID_GetVariable(TU,"tests.null",CurrIndex,VarNullVal);
          if (VarNullVal.getType() != openfluid::core::Value::NULLL)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect null value (tests.null) get by reference");
          ...
          if (VarVectorVal.getSize() != RefVectorSize)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector size");
          ...
          OPENFLUID_SetVariable(TU,"tests.vector",CurrIndex,NewVect);

          OPENFLUID_GetVariable(TU,"tests.vector",CurrIndex,&VarVectorVal);
          if (VarVectorVal.getSize() != NewVectorSize)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector size after update");

          if (!openfluid::tools::IsCloseEnough(VarVectorVal[0],NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector value at index 0 after update");

          if (!openfluid::tools::IsCloseEnough(VarVectorVal[4],NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector value at index 4 after update");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarVectorVal.getSize() != NewVectorSize)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector size at t-1");

            if (!openfluid::tools::IsCloseEnough(VarVectorVal[0],PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector value at index 0 at t-1");

            if (!openfluid::tools::IsCloseEnough(VarVectorVal[4],PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector value at index 4 at t-1");
          ...
          if (VarMatrixVal.getColsNbr() != RefMatrixColsNb)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix cols nb");
          if (VarMatrixVal.getRowsNbr() != RefMatrixRowsNb)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix rows nb");

          VarMatrixVal.clear();
          OPENFLUID_GetVariable(TU,"tests.matrix",CurrIndex,VarMatrixVal);
          if (VarMatrixVal.getColsNbr() != RefMatrixColsNb)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix cols nb get by reference");
          if (VarMatrixVal.getRowsNbr() != RefMatrixRowsNb)
          ...
          OPENFLUID_SetVariable(TU,"tests.matrix",CurrIndex,NewMatrix);

          OPENFLUID_GetVariable(TU,"tests.matrix",CurrIndex,&VarMatrixVal);
          if (VarMatrixVal.getColsNbr() != NewMatrixColsNb)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix cols nb after update");
          if (VarMatrixVal.getRowsNbr() != NewMatrixRowsNb)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix rows nb after update");

          if (!openfluid::tools::IsCloseEnough(VarMatrixVal.get(0,0),NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix value at index 0,0 after update");

          if (!openfluid::tools::IsCloseEnough(VarMatrixVal.get(4,3),NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix value at index 4,3 after update");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarMatrixVal.getSize() != NewMatrixRowsNb*NewMatrixColsNb)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix size at t-1");

            if (!openfluid::tools::IsCloseEnough(VarMatrixVal.get(0,0),PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix value at index 0,0 at t-1");

            if (!openfluid::tools::IsCloseEnough(VarMatrixVal.get(4,3),PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix value at index 4,3 at t-1");
          ...
          if (VarMapVal.getSize() != 2)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map size");

          VarMapVal.clear();
          OPENFLUID_GetVariable(TU,"tests.map",CurrIndex,VarMapVal);
          if (VarMapVal.getSize() != 2)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map size get by reference");
          ...
          OPENFLUID_SetVariable(TU,"tests.map",CurrIndex,NewMap);

          OPENFLUID_GetVariable(TU,"tests.map",CurrIndex,&VarMapVal);
          if (VarMapVal.getSize() != 3)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map size after update");

          if (VarMapVal.getString("key1") != NewString)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key1 after update");

          if (!openfluid::tools::IsCloseEnough(VarMapVal.getDouble("key2"),NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key2 after update");

          if (VarMapVal.getBoolean("key3") != NewBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key3 after update");
          ...
          if (CurrIndex > 0 && (OPENFLUID_GetCurrentTimeIndex()-OPENFLUID_GetDefaultDeltaT()) != 0)
          {
            ...
            if (VarMapVal.getSize() != 3)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map size at t-1");

            if (VarMapVal.getString("key1") != PreString)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key1 at t-1");

            if (!openfluid::tools::IsCloseEnough(VarMapVal.getDouble("key2"),PreDouble,0.00001))
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key2 at t-1");

            if (VarMapVal.getBoolean("key3") != PreBool)
              OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key3 at t-1");
      ...
      // typed
      {
        ...
        OPENFLUID_UNITS_ORDERED_LOOP("TestUnits",TU)
        {
          ...
          OPENFLUID_SetVariable(TU,"tests.typed.double",CurrIndex,NewDouble);
          ...
          OPENFLUID_SetVariable(TU,"tests.typed.integer",CurrIndex,NewLong);
          ...
          OPENFLUID_SetVariable(TU,"tests.typed.bool",CurrIndex,NewBool);
          ...
          OPENFLUID_SetVariable(TU,"tests.typed.string",CurrIndex,NewString);
          ...
          openfluid::core::VectorValue NewVect(NewVectorSize,NewDouble);
          OPENFLUID_SetVariable(TU,"tests.typed.vector",CurrIndex,NewVect);
          ...
          if (VarVectorVal.getSize() != RefVectorSize)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect oldvector size get by reference");

          OPENFLUID_SetVariable(TU,"tests.typed.oldvector",CurrIndex,NewVect);

          OPENFLUID_GetVariable(TU,"tests.typed.oldvector",CurrIndex,VarVectorVal);
          if (VarVectorVal.getSize() != NewVectorSize)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect oldvector size after update");
          if (!openfluid::tools::IsCloseEnough(VarVectorVal[0],NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect oldvector value at index 0 after update");
          if (!openfluid::tools::IsCloseEnough(VarVectorVal[4],NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect oldvector value at index 4 after update");
          ...
          openfluid::core::MatrixValue NewMatrix(NewMatrixColsNb,NewMatrixRowsNb,NewDouble);
          OPENFLUID_SetVariable(TU,"tests.typed.matrix",CurrIndex,NewMatrix);
          ...
          NewMap.setDouble("key2",NewDouble);
          NewMap.setBoolean("key3",NewBool);
          OPENFLUID_SetVariable(TU,"tests.typed.map",CurrIndex,NewMap);
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, DOUBLE)");

          VarDouble = 0.0;
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarDouble);
          if (!openfluid::tools::IsCloseEnough(VarDouble,RefDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect double value (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewLong);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, INTEGER)");

          VarLong = 0;
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarLong);
          if (VarLong != NewLong)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect long value (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,openfluid::core::NullValue());

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::NULLL))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, NULL)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewBool);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, BOOLEAN)");

          VarBool = false;
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarBool);
          if (VarBool != NewBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect boolean value (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewString);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, STRING)");

          VarString= "";
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarString);
          if (VarString != NewString)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect string value (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewVect);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, VECTOR)");

          VarVectorVal.clear();
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarVectorVal);
          if (VarVectorVal.size() != NewVect.size())
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector size value (tests.none)");
          if (!openfluid::tools::IsCloseEnough(VarVectorVal[4],NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect vector value at index 4 (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewMatrix);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::MATRIX))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, MATRIX)");

          VarMatrixVal.clear();
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarMatrixVal);
          if (VarMatrixVal.size() != NewMatrix.size())
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix size value (tests.none)");
          if (!openfluid::tools::IsCloseEnough(VarMatrixVal.get(4,3),NewDouble,0.00001))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect matrix value at index 4,3 (tests.none)");


          OPENFLUID_SetVariable(TU,"tests.typed.none",CurrIndex,NewMap);

          if (!OPENFLUID_IsVariableExist(TU,"tests.typed.none",CurrIndex,openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect OPENFLUID_IsVariableExist (tests.none, MAP)");

          VarMapVal.clear();
          OPENFLUID_GetVariable(TU,"tests.typed.none",CurrIndex,VarMapVal);
          if (VarMapVal.size() != NewMap.size())
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map size value (tests.none)");
          if (VarMapVal.getBoolean("key3") != NewBool)
            OPENFLUID_RaiseError(THIS_FUNC_ID,"incorrect map value at key key3 (tests.none)");
        }
      }

...
#define THIS_FUNC_ID "tests.primitives.inputdata.prod"
...
class InputdataPrimitivesProdFunction : public openfluid::ware::PluggableFunction
{
  private:
  ...
  public:
    ...
    InputdataPrimitivesProdFunction() : PluggableFunction()
    {

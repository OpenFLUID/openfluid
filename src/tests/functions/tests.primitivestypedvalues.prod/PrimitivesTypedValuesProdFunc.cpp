...
void PrimitivesTypedValuesProdFunction::prepareData()
{  }
...
void PrimitivesTypedValuesProdFunction::checkConsistency()
{  }
...
void PrimitivesTypedValuesProdFunction::finalizeRun()
{  }

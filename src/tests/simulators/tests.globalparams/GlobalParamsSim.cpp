...
BEGIN_SIMULATOR_SIGNATURE("tests.globalparams")
  ...
  DECLARE_REQUIRED_PARAMETER("gparam1","","")
  DECLARE_REQUIRED_PARAMETER("gparam2","","")
  DECLARE_REQUIRED_PARAMETER("gparam3","","")
  DECLARE_REQUIRED_PARAMETER("lparam1","","")
  DECLARE_USED_PARAMETER("gparam4","","")

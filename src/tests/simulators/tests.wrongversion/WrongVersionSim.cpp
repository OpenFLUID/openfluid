...
BEGIN_SIMULATOR_SIGNATURE("tests.wrongversion")
  ...
  DECLARE_SIGNATURE_NAME("test simulator for wrong id handling");
...
*/
class WrongVersionSimulator : public openfluid::ware::PluggableSimulator
{
  private:
  ...
  WrongVersionSimulator() : PluggableSimulator()
  {
...
{
  return new WrongVersionSimulator();
}

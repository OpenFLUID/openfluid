    ...
    {
      {
        ...
        OPENFLUID_UNITS_ORDERED_LOOP("TestUnits",TU)
        {
          ...
          if (IndValueList.size() != 1)
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_GetVariables list size "
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.double",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.double, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.double",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.double, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.double",OPENFLUID_GetCurrentTimeIndex(),
                                         openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.double, timestep, DOUBLE) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.double",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.double, timestep+1, DOUBLE) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.integer",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.integer",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep, INTEGER) "
                                 "before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.integer",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep) "
                                 "after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.integer",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.integer",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep, INTEGER) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.integer",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integer, timestep+1, INTEGER) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.bool",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.bool",OPENFLUID_GetCurrentTimeIndex(),
                                        openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep, BOOLEAN) before append");

          OPENFLUID_AppendVariable(TU,"tests.bool",TheBool);

          if (!OPENFLUID_IsVariableExist(TU,"tests.bool",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.bool",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.bool",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep, BOOLEAN) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.bool",
                                        ...
                                        openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.bool, timestep+1, BOOLEAN) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.string",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.string",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep, STRING) before append");

          OPENFLUID_AppendVariable(TU,"tests.string",TheString);

          if (!OPENFLUID_IsVariableExist(TU,"tests.string",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.string",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.string",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep, STRING) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.string",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.string, timestep+1, STRING) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.doubleval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.doubleval, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.doubleval",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.doubleval, timestep, DOUBLE) "
                                 "before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.doubleval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.doubleval, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.doubleval",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.doubleval, timestep+1) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.doubleval",
                                        ...
                                        openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.doubleval, timestep+1, DOUBLE) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.integerval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integerval, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.integerval",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integerval, timestep, INTEGER) "
                                 "before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.integerval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integerval, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.integerval",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integerval, timestep+1) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.integerval",
                                        ...
                                        openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.integerval, timestep+1, INTEGER) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.boolval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.boolval",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep, BOOLEAN) "
                                 "before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.boolval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.boolval",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.boolval",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep, BOOLEAN) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.boolval",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.boolval, timestep+1, BOOLEAN) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.stringval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.stringval, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.stringval",OPENFLUID_GetCurrentTimeIndex(),
                                        openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.stringval, timestep, STRING) "
                                 "before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.stringval",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.stringval, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.stringval",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.stringval, timestep+1) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.stringval",
                                        ...
                                        openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.stringval, timestep+1, STRING) "
                                 "after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.null",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.null",OPENFLUID_GetCurrentTimeIndex(),
                                        openfluid::core::Value::NULLL))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep, NULLL) before append");

          OPENFLUID_AppendVariable(TU,"tests.null",TheNull);

          if (!OPENFLUID_IsVariableExist(TU,"tests.null",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.null",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.null",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::NULLL))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep, NULLL) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.null",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::NULLL))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.null, timestep+1, NULLL) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.vector",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.vector",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep, VECTOR) before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.vector",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.vector",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.vector",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep, VECTOR) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.vector",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.vector, timestep+1, VECTOR) after append");

          // matrix value

          if (!OPENFLUID_IsVariableExist(TU,"tests.matrix"))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix)");

          if (OPENFLUID_IsVariableExist(TU,"tests.matrix",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep) before append");

          if (OPENFLUID_IsVariableExist(TU,"tests.matrix",
                                        OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::MATRIX))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep, MATRIX) before append");
          ...
          if (!OPENFLUID_IsVariableExist(TU,"tests.matrix",OPENFLUID_GetCurrentTimeIndex()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.matrix",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.matrix",
                                         OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::MATRIX))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep, MATRIX) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.matrix",
                                        OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::MATRIX))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.matrix, timestep+1, MATRIX) after append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.map",OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.map, timestep, MAP) before append");
          ...
          if (OPENFLUID_IsVariableExist(TU,"tests.map",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT()))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.map, timestep+1) after append");

          if (!OPENFLUID_IsVariableExist(TU,"tests.map",OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.map, timestep, MAP) after append");

          if (OPENFLUID_IsVariableExist(TU,"tests.map",OPENFLUID_GetCurrentTimeIndex()+OPENFLUID_GetDefaultDeltaT(),
                                        openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsVariableExist (tests.map, timestep+1, MAP) after append");
...

      {
        ...
        OPENFLUID_UNITS_ORDERED_LOOP("TestUnits",TU)
        {
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.none",
            ...
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.none, timestep, NONE) before append");
          ...
          if (!OPENFLUID_IsTypedVariableExist(TU,"tests.typed.none",
                                              OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::NONE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.none, timestep, NONE) after append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.double",
                                             OPENFLUID_GetCurrentTimeIndex(), openfluid::core::Value::DOUBLE))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.double, timestep, DOUBLE) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.integer",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.integer, timestep, INTEGER) "
                                 "before append");
          ...
          if (!OPENFLUID_IsTypedVariableExist(TU,"tests.typed.integer",OPENFLUID_GetCurrentTimeIndex(),
                                              openfluid::core::Value::INTEGER))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist "
          ...
          if (!OPENFLUID_IsTypedVariableExist(TU,"tests.typed.bool", openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.bool, BOOLEAN)");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.bool",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::BOOLEAN))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.bool, timestep, BOOLEAN) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.string",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::STRING))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.string, timestep, STRING) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.vector",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.vector, timestep, VECTOR) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.oldvector",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::VECTOR))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.oldvector, timestep, VECTOR) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.matrix",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::MATRIX))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.matrix, timestep, MATRIX) "
                                 "before append");
          ...
          if (OPENFLUID_IsTypedVariableExist(TU,"tests.typed.map",OPENFLUID_GetCurrentTimeIndex(),
                                             openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.map, timestep, MAP) "
                                 "before append");
          ...
          if (!OPENFLUID_IsTypedVariableExist(TU,"tests.typed.map",OPENFLUID_GetCurrentTimeIndex(),
                                              openfluid::core::Value::MAP))
            OPENFLUID_RaiseError(THIS_SIM_ID,
                                 "incorrect OPENFLUID_IsTypedVariableExist (tests.map, timestep, MAP) after append");
        }

...
BEGIN_SIMULATOR_SIGNATURE("tests.coupling.C")
  ...
  DECLARE_SIGNATURE_NAME("test simulator for coupling");
...
*/
class CouplingCSimulator : public openfluid::ware::PluggableSimulator
{
  private:
  ...
  CouplingCSimulator() : PluggableSimulator()
  {

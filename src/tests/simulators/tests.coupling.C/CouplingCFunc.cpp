...
BEGIN_SIMULATOR_SIGNATURE("tests.coupling.C")
...
*/
class CouplingCFunction : public openfluid::ware::PluggableSimulator
{
  private:
  ...
  CouplingCFunction() : PluggableSimulator()
  {
    m_DeltaTList.push_back(Duration(60));
    m_DeltaTList.push_back(Duration(60));
    m_DeltaTList.push_back(Duration(60));
    m_DeltaTList.push_back(Duration(60));
    m_DeltaTList.push_back(Duration(47));
  ...
  openfluid::base::SchedulingRequest initializeRun()
  {
    ...
    {
      OPENFLUID_InitializeVariable(TU,"varC",(long)0);
    }
  ...
  openfluid::base::SchedulingRequest runStep()
  {
    ...
    OPENFLUID_UNITS_ORDERED_LOOP("TestUnits",TU)
    {
      OPENFLUID_AppendVariable(TU,"varC",(long)OPENFLUID_GetCurrentTimeIndex());
    }
...
DEFINE_SIMULATOR_CLASS(CouplingCFunction)

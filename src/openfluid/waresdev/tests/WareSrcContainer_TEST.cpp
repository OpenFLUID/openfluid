...
BOOST_AUTO_TEST_CASE(searchMainCppFileName)
{
  ...
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (SIM_CPP file.cpp )").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(SIM_CPP file.cpp )").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(SIM_CPP file.cpp)").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName(" SET (SIM_CPP file.cpp ) ").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (SIM_CPP file.cpp other_file.cpp)").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (SIM_CPP file.cpp other_file.cpp) ").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(SIM_CPP file.cpp other_file.cpp)").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("# list of CPP files, the sim2doc tag must be contained in the first one\n"
      "# ex: SET(SIM_CPP MySimulator.cpp)\n"
      "SET(SIM_CPP file.cpp other_file.cpp)\n").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("# list of CPP files, the sim2doc tag must be contained in the first one\n"
      "# ex: SET(SIM_CPP MySimulator.cpp)\n"
      "#SET(SIM_CPP file.cpp)\n").toStdString(),"");

  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (OBS_CPP file.cpp )").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(OBS_CPP file.cpp )").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(OBS_CPP file.cpp)").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName(" SET (OBS_CPP file.cpp ) ").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (OBS_CPP file.cpp other_file.cpp)").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET (OBS_CPP file.cpp other_file.cpp) ").toStdString(),"file.cpp");
  BOOST_CHECK_EQUAL(openfluid::waresdev::WareSrcContainer::searchMainCppFileName("SET(OBS_CPP file.cpp other_file.cpp)").toStdString(),"file.cpp");
}
...
BOOST_FIXTURE_TEST_CASE(getDefaultFiles,F)
{
  ...
  List = openfluid::waresdev::WareSrcContainer(m_RealDirs.at(6),openfluid::waresdev::WareSrcManager::SIMULATOR,"").getDefaultFiles();
  BOOST_CHECK_EQUAL(List.count(),0);

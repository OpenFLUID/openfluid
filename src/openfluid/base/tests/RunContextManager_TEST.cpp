...
BOOST_AUTO_TEST_CASE(check_project_fileformat_conversion_simple)
{
  ...
  BOOST_CHECK_EQUAL(CtxtMan->getProjectCreationDate(),"2021-06-10T14:04:35");
  BOOST_CHECK_EQUAL(CtxtMan->getProjectLastModDate(),"2021-06-10T14:04:36");
...
BOOST_AUTO_TEST_CASE(check_project_fileformat_conversion_complex)
{
  ...
  BOOST_CHECK_EQUAL(CtxtMan->getProjectCreationDate(),"2015-09-24T10:16:40");
  BOOST_CHECK_EQUAL(CtxtMan->getProjectLastModDate(),"2015-09-24T10:16:40");

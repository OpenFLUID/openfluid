...
#include <openfluid/guicommon-gtk/MarketClientAssistant.hpp>
...
#include <openfluid/guicommon-gtk/ViewLogFileWindow.hpp>
#include <openfluid/guicommon-gtk/PreferencesManager.hpp>
#include <openfluid/guicommon-gtk/MarketPackWidgetFormat.hpp>

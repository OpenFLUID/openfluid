...
/**
  \file ObserversListInstance.cpp
  \brief Implements ...
...
ObserversListInstance::ObserversListInstance(openfluid::machine::SimulationBlob& SimulationBlob):
...
ObserversListInstance::~ObserversListInstance()
{
  if (m_Initialized)
    finalize();

  if (m_Initialized)
    throw openfluid::base::OFException("OpenFLUID framework","ObserversListInstance::~ObserversListInstance()","Destroyed initialized ObserversList");
}
...
void ObserversListInstance::appendObserver(ObserverInstance* ObsInstance)
{
  if (m_Initialized)
...
void ObserversListInstance::finalize()
{
  if (!m_Initialized)
    throw openfluid::base::OFException("OpenFLUID framework","ObserversListInstance::finalize()","Trying to finalize an uninitialized observers list");
...
void ObserversListInstance::call_initParams() const
{
  std::list<ObserverInstance*>::const_iterator ObsIter;
...
void ObserversListInstance::call_onPrepared() const
{
  std::list<ObserverInstance*>::const_iterator ObsIter;
...
void ObserversListInstance::call_onInitializedRun() const
{
  std::list<ObserverInstance*>::const_iterator ObsIter;
...
void ObserversListInstance::call_onStepCompleted() const
{
  std::list<ObserverInstance*>::const_iterator ObsIter;
...
void ObserversListInstance::call_onFinalizedRun() const
{
  std::list<ObserverInstance*>::const_iterator ObsIter;

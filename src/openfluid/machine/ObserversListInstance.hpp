...
/**
  \file ObserversListInstance.hpp
  \brief Header of ...
...
#ifndef __OBSERVERSLISTINSTANCE_HPP__
#define __OBSERVERSLISTINSTANCE_HPP__
...
class DLLEXPORT ObserversListInstance
{
  private:
  ...
  public:
    ...
    ObserversListInstance(openfluid::machine::SimulationBlob& SimulationBlob);

    ~ObserversListInstance();
...
#endif /* __OBSERVERSLISTINSTANCE_HPP__ */

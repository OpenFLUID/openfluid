...
class OPENFLUID_API WarePluginsSearchResults
{
  private:
    ...
    std::vector<SignatureType*> m_AvailablePlugins;
  ...
  public:
    ...
    void appendAvailable(SignatureType* Item);

    void appendErrored(const std::string& Path,const std::string& Message);

    const std::vector<SignatureType*> availablePlugins() const;
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::writeListToStreamAsText(std::ostream& OutStm,bool WithErrors) const
{
  for (auto& Plug : m_AvailablePlugins)
  {
  ...
  if (WithErrors && !m_ErroredFiles.empty())
  {
    for (auto& EFile : m_ErroredFiles)
    {
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareMetaForText(const openfluid::ware::SimulatorSignature* Sign,
                                                                    std::ostream& OutStm) const
{  
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareMetaForText(const openfluid::ware::ObserverSignature* /*Sign*/,
                                                                    std::ostream& /*OutStm*/) const
{
  // nothing to be done  
}
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addSchedulingDetailsForText(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addDataForText(const openfluid::ware::SignatureDataItem& Item, 
                                                              const std::string& CatStr, std::ostream& OutStm) const
{
  std::ostringstream oss;
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addSpatialDataForText(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addTypedSpatialDataForText(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addDataDetailsForText(const openfluid::ware::SimulatorSignature* Sign, 
                                                                    std::ostream& OutStm) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addGraphDetailsForText(const openfluid::ware::SimulatorSignature* Sign, 
                                                                     std::ostream& OutStm) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareDynaForText(const openfluid::ware::SimulatorSignature* Sign,
                                                                    std::ostream& OutStm) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareDynaForText(const openfluid::ware::ObserverSignature* /*Sign*/,
                                                                    std::ostream& /*OutStm*/) const
{
  // nothing to be done  
}
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::writeToStreamAsText(std::ostream& OutStm,bool WithErrors) const
{
  bool First = true;
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addErrorsToJSONDoc(rapidjson::Document& Doc, 
...
template<class SignatureType>
std::string WarePluginsSearchResults<SignatureType>::getJSONAsString(rapidjson::Document& Doc)
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::writeListToStreamAsJSON(std::ostream& OutStm,bool WithErrors) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addDataForJSON(const openfluid::ware::SignatureDataItem& Item,
                        rapidjson::Value& Arr,rapidjson::Document::AllocatorType& Alloc) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addSpatialDataForJSON(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addTypedSpatialDataForJSON(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addDataDetailsForJSON(
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addGraphDetailsForJSON(const openfluid::ware::SimulatorSignature* Sign,
                                                                     rapidjson::Value& Obj,
                                                                     rapidjson::Document::AllocatorType& Alloc) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareDetailsForJSON(const openfluid::ware::SimulatorSignature* Sign, 
                                                                   rapidjson::Value& Obj, 
                                                                   rapidjson::Document::AllocatorType& Alloc) const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::addWareDetailsForJSON(const openfluid::ware::ObserverSignature* /*Sign*/, 
                                                                   rapidjson::Value& /*Obj*/, 
                                                                   rapidjson::Document::AllocatorType& /*Alloc*/) const
{
  // nothing to be done
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::writeToStreamAsJSON(std::ostream& OutStm,bool WithErrors) const
{
  rapidjson::Document JSON;
  JSON.SetObject();
  rapidjson::Document::AllocatorType& JSONalloc = JSON.GetAllocator();
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::appendAvailable(SignatureType* Item)
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::appendErrored(const std::string& Path,const std::string& Message)
{
...
template<class SignatureType>
const std::vector<SignatureType*> WarePluginsSearchResults<SignatureType>::availablePlugins() const
{
...
template<class SignatureType>
const std::map<std::string,std::string> WarePluginsSearchResults<SignatureType>::erroredFiles() const
{
...
template<class SignatureType>
void WarePluginsSearchResults<SignatureType>::writeToStream(std::ostream& OutStm,

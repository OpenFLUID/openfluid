...
class DLLEXPORT MarketSrcFunctionPackage : public MarketSrcPackage
{
  public:

    MarketSrcFunctionPackage(const openfluid::ware::WareID_t& ID, const std::string& PackageURL);
...
#endif /* __MARKETSRCFUNCTIONPACKAGE_HPP__ */

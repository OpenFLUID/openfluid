...
void MarketPackage::setWorksDirs(std::string TempDir, std::string MarketBagFunctionDir,
    std::string MarketBagObserverDir, std::string MarketBagDatasetDir, std::string MarketBagBinSubDir, std::string MarketBagSrcSubDir)
{

                                             ...
                                             const std::string Suffix, const std::string VectorName)
{
  ...
  if (VectorName == "")
  {
    GeneratedName << ".scalars." << openfluid::config::OUTFILES_EXT;
  }
  else
  {
    GeneratedName << ".vector." << VectorName<< "." << openfluid::config::OUTFILES_EXT;
  }
    ...
    const std::string CommentChar)
{
  ...
  GeneratedHeader << CommentChar << " simulation ID: " << openfluid::base::RuntimeEnvironment::getInstance()->getSimulationID() << "\n"
  << CommentChar << " file: " << Filename << "\n"
  << CommentChar << " date: " << boost::posix_time::to_simple_string(openfluid::base::RuntimeEnvironment::getInstance()->getIgnitionDateTime()) << "\n"
    ...
    unsigned int Precision)
{
  ...
  {
    GeneratedContent << openfluid::tools::GenerateDateTimeFromStep(SimInfo->getStartTime(),SimInfo->getTimeStep(),iStep).getAsString(DateFormat);

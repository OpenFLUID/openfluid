...
#ifndef __SCALAROUTPUTSFILEWRITER_HPP__
#define __SCALAROUTPUTSFILEWRITER_HPP__
...
class ScalarOutputsFileWriter : public OutputsFileWriter
{
  private:
...
#endif /* __SCALAROUTPUTSFILEWRITER_HPP__ */

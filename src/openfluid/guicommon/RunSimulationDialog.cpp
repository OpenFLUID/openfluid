  ...
  m_Launched(false), m_Success(false)
{
  ...
  setStage(openfluid::guicommon::RunSimulationListener::RUNW_BEFORE);

  mp_Listener = new openfluid::guicommon::RunSimulationListener();
  QThread* WThread = new QThread;
  openfluid::guicommon::RunSimulationWorker* Worker = new openfluid::guicommon::RunSimulationWorker(mp_FXDesc,mp_Listener);
  ...
  qRegisterMetaType<openfluid::guicommon::RunSimulationListener::Stage>("openfluid::guicommon::RunSimulationListener::Stage");
  ...
  connect(mp_Listener,SIGNAL(stageChanged(openfluid::guicommon::RunSimulationListener::Stage)),
          this,SLOT(setStage(openfluid::guicommon::RunSimulationListener::Stage)));
...
void RunSimulationDialog::setStage(openfluid::guicommon::RunSimulationListener::Stage S)
{
  if (S == openfluid::guicommon::RunSimulationListener::RUNW_BEFORE)
  {
  ...
  else if (S == openfluid::guicommon::RunSimulationListener::RUNW_PRESIM)
  {
  ...
  else if (S == openfluid::guicommon::RunSimulationListener::RUNW_INIT)
  {
  ...
  else if (S == openfluid::guicommon::RunSimulationListener::RUNW_RUN)
  {
    ui->PresimLabel->setStyleSheet("font : bold;");
  ...
  else if (S == openfluid::guicommon::RunSimulationListener::RUNW_FINAL)
  {
    ui->PresimLabel->setStyleSheet("font : bold;");
    ui->InitLabel->setStyleSheet("font : bold;");
  ...
  else if (S == openfluid::guicommon::RunSimulationListener::RUNW_AFTER)
  {
    ui->PresimLabel->setStyleSheet("font : bold;");
    ui->InitLabel->setStyleSheet("font : bold;");
    ui->RunLabel->setStyleSheet("font : bold;");

...
/**
  @file RunConfigurationDescriptor_TEST.cpp
...
#define BOOST_TEST_MODULE unittest_runconfigurationdescriptor
...
{
  openfluid::fluidx::RunConfigurationDescriptor RunDesc(57,openfluid::core::DateTime(2010,1,7,16,24,13),

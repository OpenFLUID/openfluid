...
{
  openfluid::fluidx::FluidXReader FXR(openfluid::io::IOListener());
}
...
{
  openfluid::fluidx::FluidXReader FXR = openfluid::fluidx::FluidXReader(new openfluid::io::IOListener());
  ...
  BOOST_REQUIRE_EQUAL(FXR.getModelDescriptor().getGlobalParameters().get<std::string>("gparam1"),"100");
  BOOST_REQUIRE_EQUAL(FXR.getModelDescriptor().getGlobalParameters().get<std::string>("gparam2"),"0.1");
  ...
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getVariableName(),"tests.generator.interp");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getVariableSize(),1);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getUnitClass(),"TU");
  ...
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("sources"),"sources.xml");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("distribution"),"distri.dat");

  it++;
  BOOST_REQUIRE_EQUAL((*it)->isType(openfluid::fluidx::ModelItemDescriptor::PluggedFunction),true);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::FunctionDescriptor*)(*it))->getFileID(),"tests.functionA");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::FunctionDescriptor*)(*it))->getParameters().size(),0);

  it++;
  BOOST_REQUIRE_EQUAL((*it)->isType(openfluid::fluidx::ModelItemDescriptor::Generator),true);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getVariableName(),"tests.generator.fixed");
  ...
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("fixedvalue"),"20");

  it++;
  BOOST_REQUIRE_EQUAL((*it)->isType(openfluid::fluidx::ModelItemDescriptor::Generator),true);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getVariableName(),"tests.generator.random");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getVariableSize(),1);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getUnitClass(),"TU");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getGeneratorMethod(),openfluid::fluidx::GeneratorDescriptor::Random);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().size(),2);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("min"),"20.53");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("max"),"50");


  it++;
  BOOST_REQUIRE_EQUAL((*it)->isType(openfluid::fluidx::ModelItemDescriptor::PluggedFunction),true);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::FunctionDescriptor*)(*it))->getFileID(),"tests.functionB");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::FunctionDescriptor*)(*it))->getParameters().size(),4);
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("gparam1"),"50");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("strparam"),"strvalue");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("doubleparam"),"1.1");
  BOOST_REQUIRE_EQUAL(((openfluid::fluidx::GeneratorDescriptor*)(*it))->getParameters().get<std::string>("longparam"),"11");
...
BOOST_AUTO_TEST_CASE(check_error_handling)
{
  ...
  try
  {
    openfluid::fluidx::FluidXReader(new openfluid::io::IOListener()).loadFromDirectory(boost::filesystem::path(CONFIGTESTS_INPUT_DATASETS_DIR+"/OPENFLUID.IN.FluidXReader/pathdoesnotexist").string());
  }
  catch (...)
  {
    HasFailed = true;
  ...
  try
  {
    openfluid::fluidx::FluidXReader(new openfluid::io::IOListener()).loadFromDirectory(boost::filesystem::path(CONFIGTESTS_INPUT_DATASETS_DIR+"/OPENFLUID.IN.FluidXReader/wrong-nofile").string());
  }
  catch (...)
  {
    HasFailed = true;
  ...
  try
  {
    openfluid::fluidx::FluidXReader(new openfluid::io::IOListener()).loadFromDirectory(boost::filesystem::path(CONFIGTESTS_INPUT_DATASETS_DIR+"/OPENFLUID.IN.FluidXReader/wrong-twomodels").string());
  }
  catch (...)
  {
    HasFailed = true;
  ...
  try
  {
    openfluid::fluidx::FluidXReader(new openfluid::io::IOListener()).loadFromDirectory(boost::filesystem::path(CONFIGTESTS_INPUT_DATASETS_DIR+"/OPENFLUID.IN.FluidXReader/wrong-runs").string());
  }
  catch (...)
  {
    HasFailed = true;
  ...
  BOOST_REQUIRE_THROW(openfluid::fluidx::FluidXReader(
...
BOOST_AUTO_TEST_CASE(check_observers)
{
  ...
  openfluid::fluidx::ObserversListDescriptor::SetDescription_t Observers = FXR.getObserversListDescriptor().getItems();

  BOOST_CHECK_EQUAL(Observers.size(),4);

  openfluid::fluidx::ObserversListDescriptor::SetDescription_t::iterator it = Observers.begin();

  // output.files.csv

  BOOST_CHECK((*it)->isType(openfluid::fluidx::WareDescriptor::PluggedObserver));

...
std::string FluidXWriter::getGeneratorMethodAsStr(openfluid::fluidx::GeneratorDescriptor::GeneratorMethod Method) const
{
...
void FluidXWriter::setRunConfigurationToWrite(openfluid::fluidx::RunDescriptor& RDescriptor)
{

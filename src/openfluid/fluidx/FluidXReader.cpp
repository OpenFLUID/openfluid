...
void FluidXReader::extractModelFromNode(xmlNodePtr NodePtr)
{
  ...
  while (CurrNode != NULL)
  {
    ...
    if (xmlStrcmp(CurrNode->name,(const xmlChar*)"generator") == 0)
    {
      ...
      {
        openfluid::fluidx::GeneratorDescriptor::GeneratorMethod GenMethod = openfluid::fluidx::GeneratorDescriptor::NoGenMethod;
        ...
        GD = new openfluid::fluidx::GeneratorDescriptor((const char*)xmlVarName,(const char*)xmlUnitClass,GenMethod,VarSize);
...
void FluidXReader::extractDomainDefinitionFromNode(xmlNodePtr NodePtr)
{
  ...
  while (CurrNode != NULL)
  {
    ...
    if (xmlStrcmp(CurrNode->name,(const xmlChar*)"unit") == 0)
    {
      ...
      {
        openfluid::fluidx::UnitDescriptor* UnitDesc = new openfluid::fluidx::UnitDescriptor();

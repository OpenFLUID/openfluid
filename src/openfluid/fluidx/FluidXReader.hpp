...
class DLLEXPORT FluidXReader
{
  ...
  public:
    ...
    openfluid::fluidx::CoupledModelDescriptor& getModelDescriptor() {return m_ModelDescriptor; };

    openfluid::fluidx::RunDescriptor& getRunDescriptor() {return m_RunDescriptor; };

    openfluid::base::OutputDescriptor& getOutputDescriptor() {return m_OutputDescriptor; };

    openfluid::fluidx::DomainDescriptor& getDomainDescriptor() {return m_DomainDescriptor; };

    openfluid::fluidx::DatastoreDescriptor& getDatstoreDescriptor() {return m_DatastoreDescriptor; };

    openfluid::fluidx::ObserversListDescriptor& getObserversListDescriptor() { return m_ObserversListDescriptor; };

...
#ifndef __OPENFLUID_UICOMMON_MULTIPOLYGONGRAPHICS_HPP__
#define __OPENFLUID_UICOMMON_MULTIPOLYGONGRAPHICS_HPP__
...
#endif /* __OPENFLUID_UICOMMON_MULTIPOLYGONGRAPHICS_HPP__ */

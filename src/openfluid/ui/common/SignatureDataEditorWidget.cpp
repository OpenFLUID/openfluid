...
bool SignatureDataEditorWidget::areAllCellsValid(const QString& Header, const DataTableType& HandledDataType)
{
...
bool SignatureDataEditorWidget::areAllCellsEmpty(const QString& Header)
{
  if(!m_ColHeadersValuesMap.contains(Header))
  {
    throw openfluid::base::FrameworkException(OPENFLUID_CODE_LOCATION,

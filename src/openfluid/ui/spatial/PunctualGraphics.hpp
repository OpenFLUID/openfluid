...
#ifndef __OPENFLUID_UISPATIAL_PUNCTUALGRAPHICS_HPP__
#define __OPENFLUID_UISPATIAL_PUNCTUALGRAPHICS_HPP__
...
#endif /* __OPENFLUID_UISPATIAL_PUNCTUALGRAPHICS_HPP__ */

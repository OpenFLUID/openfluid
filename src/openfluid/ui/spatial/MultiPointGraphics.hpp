...
#ifndef __OPENFLUID_UISPATIAL_MULTIPOINTGRAPHICS_HPP__
#define __OPENFLUID_UISPATIAL_MULTIPOINTGRAPHICS_HPP__
...
#endif /* __OPENFLUID_UISPATIAL_MULTIPOINTGRAPHICS_HPP__ */
